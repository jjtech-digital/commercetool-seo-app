import {
  ...
  import ActionRendererDescription from '../Renderers/ActionRendererDescription';
  ...
  const DescriptionTableContainer = () => {
    ...
    const components = useMemo(
      () => ({
        actionRenderer: ActionRendererDescription,
      }),
      []
    );
      ...
      <div className={`${styles.tableContainer}`}>
        <div className={`${styles.tableSearchSection}`}>
          <div className={`${styles.searchBar}`}>
            <SearchTextInput
              placeholder="Search by Product key, Name, description or key features"
              value={search}
